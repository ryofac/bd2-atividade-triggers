# Atividade de Banco de Dados II: Triggers

Este projeto é uma atividade de treinamento para compreender o funcionamento dos triggers em um banco de dados.
...
- **`sql-scripts/`**: Diretório contendo os scripts SQL a serem executados no banco de dados.
